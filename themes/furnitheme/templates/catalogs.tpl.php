...
<article class="catalogs">
	<section>
		<h4><img src="<?php print $files?>/brands/natuzzi-italia-logo.jpg" /> (Natuzzi Italia)</h4>
		<ul>
	...
	<section>
		<h4><img src="<?php print $files?>/brands/natuzzi-editions-logo.jpg" /> (Natuzzi Editions)</h4>
		<ul>
	...
	<section>
		<h4><img src="<?php print $files?>/brands/bdi-logo.gif" /> (BDI)</h4>
		<ul>
			<li><a href="https://www.dropbox.com/s/gbcrh0jcrwd8f0u/bdi-home-theater-furniture-brochure-2013.pdf" title="BDI Home Theater Furniture Product Catalog"><?php print $pdf_icon?>BDI Home Theater Furniture Product Catalog</a></li>	
			<li><a href="https://www.dropbox.com/s/uvvmuxx8xprb6pc/bdi-office-furniture-brochure-2012.pdf" title="BDI Office Furniture Catalog"><?php print $pdf_icon?>BDI Office Furniture Catalog</a></li>	
			<li><a href="https://www.dropbox.com/s/ucu42jp84q7m4uu/bdi-semblance-modular-system-brochure-2012.pdf" title="BDI Semblance Modular System Catalog"><?php print $pdf_icon?>BDI Semblance Modular System Catalog</a></li>
		</ul>
	</section>
</article>