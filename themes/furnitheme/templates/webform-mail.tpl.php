...
<?php
	...
	$n = node_load($nid);
	$image = $n->field_photo[0];
	$preset_name = 'newfurn_coll_thumb';//$user ? 'newfurn_coll_slider_img' : 'newfurn_coll_thumb';
	$item_pic = theme('imagecache', $preset_name, $image['filepath'], $image['origname'], $n->title, array());
  ...
  <tr>
    <td>
      <table cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;border-spacing:0;">
        ...
        <!-- LOGO -->
        <tr><td style="text-align:center;"><span><a href="http://www.furnitalia.com" target="_blank"  rel="nofollow" title="Furnitalia" style="text-decoration:none"><img src="http://www.furnitalia.com/sites/all/themes/new_furn/images/webmail/logo.jpg" alt="Furnitalia" border="0" width="599" height="100"/></a></span></td></tr>
        <!-- MENU -->
        <tr>
          <td style="text-align:center; background-color:#CCCCCC; color:#A29999; text-transform:uppercase;max-height:26px;font-family:Arial, Helvetica, sans-serif;">
            <table cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;border-spacing:0;max-height:26px;">
              <tr><td colspan="7" style="height:7px;max-height:7px">
                <div style="height:7px;max-height:7px;overflow:hidden;"><img src="http://www.furnitalia.com/sites/all/themes/new_furn/images/webmail/spacer-grey.gif" style="height:3px;" border="0"/></div>
              </td></tr>
              <tr>
        ...
        <tr>
          <td style="height:15px">
            <span><img src="http://www.furnitalia.com/sites/all/themes/new_furn/images/webmail/space.gif" style="height:15px;" border="0"/></span>
          </td>
        </tr>
        <!-- CONTENT -->
        <tr>
				...
				<tbody>
					<tr>                        
						<td width="9" height="159" align="left" valign="top">
							<img src="http://www.furnitalia.com/sites/all/themes/new_furn/images/webmail/space.gif" alt="" width="9" height="159" hspace="0" vspace="0" border="0" style="display:block;">
						</td>                        
						<td width="595" align="left" valign="top">
							<table width="595" border="0" cellspacing="0" cellpadding="0">                            
							<tbody>
								<tr>                              
									<td width="370" height="135" align="left" valign="top" style="font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px;font-weight:normal;text-decoration:none;color:#555555;">
										<span style="font-family:Verdana, Arial, Helvetica, sans-serif;font-size:19px;font-weight:bold;text-decoration:none;color:#E12800;">
										You have chosen wisely...</span>
										<br/>                 
										<p>Hello <span style="font-style:italic;">%value[first_name]</span>, we have 
										received your 
										request for the &quot;<span style="font-weight:bold; font-style:italic;"><a href="http://sale.furnitalia.com/<?php print $url; ?>" rel="nofollow" target="_blank" ><?php print $n->title; ?></a></span>&quot;
										collection. One of Furnitalia&quot;s design consultants will be in contact with you shortly to help you choose a product that will transform your space and showcase your distinct style and taste.
										</p>      
										<p>Within the next 24 hours we will send you a confirmation e-mail to the e-mail address you provided <strong>%value[email]</strong>.</p>
									...
									<td style="width:215px" width="215">
										<?php print $item_pic; ?>
									</td>                            
								</tr>                            
        ...
        <tr>
          <td style="height:15px">
            <span><img src="http://www.furnitalia.com/sites/all/themes/new_furn/images/webmail/space.gif" style="height:40px;" border="0"/></span>
          </td>
        </tr>
        <!-- STORES -->
        <tr>
          <td>
            <table cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; border-spacing:0;">
              <tr style="text-align:center">
                ...
                <td>
                  <span>
                    <a href="http://www.furnitalia.com" title="Furnitalia" rel="nofollow" target="_blank" style="text-decoration:none"><img src="http://www.furnitalia.com/sites/all/themes/new_furn/images/webmail/website.jpg" style="height:41px;width:181px" border="0" alt="Furnitalia.com"/></a>
                  </span>
                </td>
                <td>
                  <span style="color:#AB0000; font-family:Arial, Verdana, sans-serif; font-size:13px">
        ...
        <tr>
          <td style="text-align:center;">
            <table cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;border-spacing:0;">
              <tr>
                <td style="width:25%; text-align:center;"><span><a href="http://www.facebook.com/pages/Sacramento-CA/Furnitalia/65283884934" rel="nofollow" target="_blank" title="Follow Furnitalia on Facebook!" style="text-decoration:none"><img src="http://www.furnitalia.com/sites/all/themes/new_furn/images/webmail/facebook.jpg" alt="Furnitalia on Facebook!" border="0" width="122" height="50"/></a></span></td>
                <td style="width:20%; text-align:center;"><span><a href="http://www.twitter.com/furnitalia" rel="nofollow" target="_blank" title="Follow Furnitalia on Twitter!" style="text-decoration:none"><img src="http://www.furnitalia.com/sites/all/themes/new_furn/images/webmail/twitter.jpg" alt="Furnitalia on Twitter!" border="0" width="114" height="50"/></a></span></td>
                <td style="width:15%; text-align:center;"><span><a href="http://www.flickr.com/photos/furnitalia/" rel="nofollow" target="_blank" title="Follow Furnitalia on Flickr!" style="text-decoration:none"><img src="http://www.furnitalia.com/sites/all/themes/new_furn/images/webmail/flickr.jpg" alt="Furnitalia on Flickr!" border="0" width="85" height="50"/></a></span></td>
                <td style="width:20%; text-align:center;"><span><a href="http://www.youtube.com/user/Furnitalia" rel="nofollow" target="_blank" title="Follow Furnitalia on Youtube!" style="text-decoration:none"><img src="http://www.furnitalia.com/sites/all/themes/new_furn/images/webmail/youtube.jpg" alt="Furnitalia on Youtube!" border="0" width="96" height="50"/></a></span></td>
                <td style="width:20%; text-align:center;"><span><a href="http://www.yelp.com/biz/furnitalia-sacramento" rel="nofollow" target="_blank" title="Check Furnitalia out on Yelp!" style="text-decoration:none"><img src="http://www.furnitalia.com/sites/all/themes/new_furn/images/webmail/yelp.jpg" alt="Furnitalia on Yelp!" border="0"  width="84" height="50" /></a></span></td>                             
              </tr>
            </table>
          </td>
        </tr>
...
<?php else: ?>
	...
	<div class="request">
		...
		<?php if ($nid) : ?>
		<p>If you are unable to locate the item, click the link <a href="http://www.furnitalia.com/<?php print $url; ?>" rel="nofollow" target="_blank" >here</a></p>
		<?php endif; ?>
		<p><span style="font-weight:bold;">The submission has been posted to Sales Force for processing.</span></p>
	</div>
<?php endif; ?>
