...
<section class="natuzzi-cat furn-truncate clearfix" data-maxheight="225">
	<h2 class="field-label">Natuzzi Editions - Design. Comfort. Craftsmanship.</h2>
	<img src="<?php print $theme_path ?>/images/editions.png" style="float:left;margin: 0 .5em 0 0;position: relative;" />

	<p style="line-height: 130%;font-size: 1.1em;margin:0">A brand for the American Market, Natuzzi Editions is made by the experience of the Natuzzi Group and manufactured globally.</p> 
	...
	Our furniture styles are designed with you in mind – classic, casual, 
