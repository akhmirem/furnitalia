<?php $files_dir = base_path() . variable_get('file_public_path', conf_path() . '/files'); ?>

<article id="moving-sale" style="font-size:1.5em; line-height:1.5em">
	<p>Dear Preferred Customer,</p>
	
	<p><span style="font-weight:700">Sacramento’s two premiere destinations for contemporary
	...
	<span style="font-weight:700;" class="furn-red">Fantastic Moving Sale!</span></p>
	
	<p>Much of our combined inventory must be sold off the floor
	...
	<p style="font-size:2em;text-align:center;font-weight:700;line-height:1.2em" class="furn-red furn-ucase">WE MOVE, YOU SAVE!</p>
	
	<p style="text-align:center"><img src="<?php print $files_dir;?>/promo/moving_sale/435x200_NatuzziOnlineAd.jpg"  alt="Moving sale at Furnitalia"/></p>
	...
	<section class="store-info clearfix">
		...
		<div class="store-descr">		
			...
			<p class="info info-left"><span class="store-address">
				5270 Auburn Boulevard <br/>
				Sacramento, California 95841</span><br/>
				<span class="location-label">Located in the Copenhagen Plaza,
				 on the corner of Madison Avenue and
				Auburn Boulevard next to the U-haul Rentals.</span>
			</p>
			
			<p class="info info-right">
				Phone: <br/><a href="tel:+19164840333" class="phone furn-grey">(916) 484–0333</a> <br/>
				<span class="store-subtext">Hours: <span class="working-hours"><br/>Monday – Sunday <br/>
				10:00 am – 6:00 pm</span></span>
				<a href="https://maps.google.com/maps?saddr=&daddr=Furnitalia,+5270+Auburn+Boulevard,+Sacramento,+CA+95841&z=11" target="_blank" class="directions-link furn-button-text">GET DIRECTIONS</a>
	...
	<p style="font-size:.7em;line-height:1.2em">
